<template>
	<div class="component">
		<v-toolbar>
			...
			<upload-btn class="hidden-sm-and-down" :directory="directory" target="menu" color="success"></upload-btn>
		</v-toolbar>
		...
		<v-speed-dial v-model="fab" bottom right fixed direction="top" transition="scale-transition" class="hidden-md-and-up">
			<template #activator>
				<v-btn v-model="fab" dark color="success" fab>
			...
			<upload-btn fab dark :directory="directory" target="menu" color="success">
